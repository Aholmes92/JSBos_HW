...
// 3.  Get the name Catelyn (Tully) Stark
 gameOfThronesHouses[6]["people"]["name"]//OR
...
var houseNames = gameOfThonesHouses.map(function(house){
  return house.name;
 })

// 6.  Get a list of all the peoples names
var peopleNames = gameOfThonesHouses.map(function(house){
